    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-card">{{'Card Type' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-card" class="uk-form-width-medium" ng-model="widget.data['card']">
                            ...
                            <option value="sequence1">{{'Card/Card Primary' | trans}}</option>
                            <option value="sequence2">{{'Card/Card Secondary' | trans}}</option>
                            <option value="sequence3">{{'Card Primary/Card Secondary' | trans}}</option>
                            <option value="sequence4">{{'Card Secondary/Card Primary' | trans}}</option>
                        </select>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="nx-card-size">{{'Card Size' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="nx-card-size" class="uk-form-width-medium" ng-model="widget.data['card_size']">
                            <option value="default">{{'Default' | trans}}</option>
                            <option value="small">{{'Small' | trans}}</option>
                            <option value="large">{{'Large' | trans}}</option>
                        </select>
            ...
            <li>
                ...
                <div class="uk-form-row" >
                    ...
                    <div class="uk-form-controls uk-form-controls-text">
                        <p class="uk-form-controls-condensed">
                            <label><input type="checkbox" ng-model="widget.data['content_truncate']"> {{'Truncate Content' | trans}}</label>
                        </p>
                        <p class="uk-form-controls-condensed" ng-if="widget.data.content_truncate == true">
                            <label><input type="text" ng-model="widget.data['content_truncate_size']"> {{'max Characters' | trans}}</label>
                        </p>
                        <p class="uk-form-controls-condensed" ng-if="widget.data.content_truncate == true">
                            <label><input type="checkbox" ng-model="widget.data['content_truncate_end']"> {{'Append something to truncated Content' | trans}}</label>
                        </p>
                        <p class="uk-form-controls-condensed" ng-if="widget.data.content_truncate == true">
                            <label><input type="text" ng-model="widget.data['content_truncate_end_str']"> {{'Text to append' | trans}}</label>
                        </p>
                    </div>
                </div>
